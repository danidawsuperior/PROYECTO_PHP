...
echo " La persona ". $personas[2][0]. " tiene la edad de ". $personas[2][1]."<br>";
...
$personas = [ 
    ...
    1001=>[ "Juan",45,true], 
    8348=>["Luis",19,false]];
echo " La persona ". $personas[2301][0]. " tiene la edad de ". $personas[2301][1]."<br>";
echo " La persona ". $personas[8348][0]. " tiene la edad de ". $personas[8348][1]."<br>";
